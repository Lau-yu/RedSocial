            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("category")) {
                        ...
                        if (category.equals("JOYAS")) {
                            mImageViewCategory.setImageResource(R.drawable.joyas);
                        }
                        else if (category.equals("ROPA ")) {
                            mImageViewCategory.setImageResource(R.drawable.ropa);
                        }
                        else if (category.equals("TECNOLOGIA")) {
                            mImageViewCategory.setImageResource(R.drawable.tecnologia);
                        }
